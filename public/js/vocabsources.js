...
$(function() {
	...
	$( "#AGROVOCfinder" ).autocomplete({
		...
		$.ajax({
			url : 'http://hive.nescent.org/ac?cv=agrovoc&',
			dataType: 'jsonp',
	...
	$( "#ITISfinder" ).autocomplete({
		source: function(request, response) {
		$.ajax({
			url : 'http://hive.nescent.org/ac?cv=itis&',
			dataType: 'jsonp',
			data: { term: request.term },
			success: function(data) {
			response($.map(data, function(item) {
	...
	$( "#LCSHfinder" ).autocomplete({
		source: function(request, response) {
		$.ajax({
			url : 'http://hive.nescent.org/ac?cv=lcsh&',
			dataType: 'jsonp',
			data: { term: request.term },
			success: function(data) {
			response($.map(data, function(item) {
	...
	$( "#MESHfinder" ).autocomplete({
		source: function(request, response) {
		$.ajax({
			url : 'http://hive.nescent.org/ac?cv=mesh&',
			dataType: 'jsonp',
			data: { term: request.term },
			success: function(data) {
			response($.map(data, function(item) {
	...
	$( "#TGNfinder" ).autocomplete({
		source: function(request, response) {
		$.ajax({
			url : 'http://hive.nescent.org/ac?cv=tgn&',
			dataType: 'jsonp',
			data: { term: request.term },
			success: function(data) {
			response($.map(data, function(item) {
